    ...
    def forward(self, x):
        ...
        for i in range(self.depth - 1):
            if i == 0:
                ...
                l = paddle.concat(l_list, axis=1)
            h_list.append(self.upmodules[i](l))
            l_list.append(self.downmodules[i](paddle.concat(h_list, axis=1)))
        
        h_list.append(self.upmodules[-1](paddle.concat(l_list, axis=1)))
        out = self.reconstruction(paddle.concat(h_list, axis=1))
